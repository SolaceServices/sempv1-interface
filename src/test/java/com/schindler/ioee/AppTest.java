...
import com.solace.psg.sempv1.sempinterface.*;
...
public class AppTest
{
    ...
    {
        HashMap<Integer, com.solace.psg.sempv1.solacesempreply.RpcReply.Rpc.Show.Smrp.Subscriptions.Subscription> subscriptionHashMap = null;
    ...
    {
        try {
            configureCommands.configureSubscriptionEvents(messageVpn);
        } catch (Exception e) {
            Assert.fail("Error executing show smrp subscriptions " + e.getMessage());
        }
